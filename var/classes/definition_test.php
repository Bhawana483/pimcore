...
- imgAdv [hotspotimage]
- advMany [advancedManyToManyRelation]
- advManyObject [advancedManyToManyObjectRelation]
- revMany [reverseManyToManyObjectRelation]
- geoPoint [geopoint]
- geoBounds [geobounds]
- geoPlygon [geopolygon]
- consents [consent]
- gender [gender]
- newsletterActive [newsletterActive]
- newsletterConfirmed [newsletterConfirmed]
- targetGroup [targetGroup]
- classiStore [classificationstore]
- tables [table]
- fieldsCollection [fieldcollections]
